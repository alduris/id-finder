...
{
    internal class BlackLizardCosmetics : BaseLizardCosmetics, ICanGPUSometimes
    {
        ...
        public BlackLizardCosmetics() : base(LizardType.Black)
        {
            cosmetics.Add(Label("Black-specific cosmetics group"));
            cosmetics.Add(whiskersCosmetic = new WhiskersCosmetic());
        ...
        public ComputeShader Shader => InternalShaders.blackLizardCosmeticsShader;
