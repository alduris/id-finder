...
{
    internal class BlueLizardCosmetics : BaseLizardCosmetics, ICanGPUSometimes
    {
        ...
        public BlueLizardCosmetics() : base(LizardType.Blue)
        {
            cosmetics.Add(
                OneOf(
                    "Body cosmetic",
        ...
        public ComputeShader Shader => InternalShaders.blueLizardCosmeticsShader;
